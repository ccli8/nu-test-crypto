 ...
 *                 made in the call to mbedtls_sha512_sw_starts_ret().
 */
typedef struct mbedtls_sha512_sw_context
{
 ...
 *                 calculation.
 *
 * \deprecated     Superseded by mbedtls_sha512_sw_starts_ret() in 2.7.0
 *
 * \param ctx      The SHA-512 context to use. This must be initialized.
 ...
 */
MBEDTLS_DEPRECATED void mbedtls_sha512_sw_starts( mbedtls_sha512_sw_context *ctx,
                                               int is384 );
 ...
 *                 SHA-512 checksum calculation.
 *
 * \deprecated     Superseded by mbedtls_sha512_sw_update_ret() in 2.7.0.
 *
 * \param ctx      The SHA-512 context. This must be initialized
 *                 and have a hash operation started.
 ...
 * \param ilen     The length of the input data in Bytes.
 */
MBEDTLS_DEPRECATED void mbedtls_sha512_sw_update( mbedtls_sha512_sw_context *ctx,
                                               const unsigned char *input,
                                               size_t ilen );
 ...
 *                 the result to the output buffer.
 *
 * \deprecated     Superseded by mbedtls_sha512_sw_finish_ret() in 2.7.0.
 *
 * \param ctx      The SHA-512 context. This must be initialized
 *                 and have a hash operation started.
 ...
 */
MBEDTLS_DEPRECATED void mbedtls_sha512_sw_finish( mbedtls_sha512_sw_context *ctx,
                                               unsigned char output[64] );
 ...
 *                 internal use only.
 *
 * \deprecated     Superseded by mbedtls_internal_sha512_sw_process() in 2.7.0.
 *
 * \param ctx      The SHA-512 context. This must be initialized.
 * \param data     The buffer holding one block of data. This must be
 *                 a readable buffer of length \c 128 Bytes.
 */
MBEDTLS_DEPRECATED void mbedtls_sha512_sw_process(
 ...
 *                 output = SHA-512(input buffer).
 *
 * \deprecated     Superseded by mbedtls_sha512_sw_ret() in 2.7.0
 *
 ...
 *                 be \c 0, or the function will fail to work.
 */
MBEDTLS_DEPRECATED void mbedtls_sha512_sw( const unsigned char *input,
                                        size_t ilen,
                                        unsigned char output[64],
                                        int is384 );
