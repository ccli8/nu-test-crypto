...
const testvector_ecp_montgomery_mxP_t testvector_ecp_curve25519_mxP[] = {
    /* R = m*P (X25519 test vector #1) */
    {
        "R = m*P (X25519 test vector #1)",
        /* R = m*P */
        {
    ...
    /* Alice's public key = (Alice's private key)*G */
    {
        "Alice's public key = (Alice's private key)*G)",
        /* R = m*P */
        {
    ...
    /* Bob's public key = (Bob's private key)*G */
    {
        "Bob's public key = (Bob's private key)*G)",
        /* R = m*P */
        {
    ...
    /* Shared secret = (Alice's private key)*(Bob's public key) */
    {
        "Shared secret = (Alice's private key)*(Bob's public key)",
        /* R = m*P */
        {
    ...
    /* Shared secret = (Bob's private key)*(Alice's public key) */
    {
        "Shared secret = (Bob's private key)*(Alice's public key)",
        /* R = m*P */
        {
...
const testvector_ecp_montgomery_mxP_t testvector_ecp_curve448_mxP[] = {
    /* R = m*P (X448 test vector #1) */
    {
        "R = m*P (X448 test vector #1)",
        /* R = m*P */
        {
...
const testvector_ecp_montgomery_deduce_y_t testvector_ecp_curve25519_deduce_y[] = {
    /* Deduce Y from X for P on Curve25519 */
    {
        "P = G",
        /* P = G */
        {
...
const testvector_ecp_montgomery_deduce_y_t testvector_ecp_curve448_deduce_y[] = {
    /* Deduce Y from X for P on Curve448 */
    {
        "P = G",
        /* P = G */
        {
