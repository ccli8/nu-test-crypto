...
void test_sha1_nodata(void)
{
    ...
    mbedtls_sha1_context ctx1, ctx2;
    ...
    mbedtls_sha1_finish(&ctx2, shasum2);
...
void test_sha1_random_updates(void)
{
    ...
    mbedtls_sha1_starts(&ctx2);
    for (i = 0; i < sizeof (update_sizes) / sizeof (update_sizes[0]); i ++) {
        mbedtls_sha1_update(&ctx2, test_buf1, update_sizes[i]);
    }
    mbedtls_sha1_finish(&ctx2, shasum2);
...
void test_sha1_clone(uint32_t len1, uint32_t len2)
{
    ...
    // Clone ctx2
    mbedtls_sha1_init(&ctx2);
    mbedtls_sha1_clone(&ctx2, &ctx1);
    // Update ctx1/ctx2
    mbedtls_sha1_update(&ctx1, test_buf1, len2);
    mbedtls_sha1_update(&ctx2, test_buf1, len2);
    // Finish ctx1/ctx2
    mbedtls_sha1_finish(&ctx1, shasum1);
    mbedtls_sha1_finish(&ctx2, shasum2);
    // Free ctx1/ctx2
...
void test_sha1_perf(void)
{
    ...
    i = MAXNUM_LOOP;
    while (i --) {
        mbedtls_sha1_update(&ctx2, test_buf2, sizeof (test_buf2));
    }
    mbedtls_sha1_finish(&ctx2, shasum2);
    t2.stop();
...
void test_sha256_nodata(void)
{
    ...
    mbedtls_sha256_context ctx1, ctx2;
    ...
    mbedtls_sha256_finish(&ctx2, shasum2);
...
void test_sha256_random_updates(void)
{
    ...
    mbedtls_sha256_starts(&ctx2, 0);
    for (i = 0; i < sizeof (update_sizes) / sizeof (update_sizes[0]); i ++) {
        mbedtls_sha256_update(&ctx2, test_buf1, update_sizes[i]);
    }
    mbedtls_sha256_finish(&ctx2, shasum2);
...
void test_sha256_clone(uint32_t len1, uint32_t len2)
{
    ...
    // Clone ctx2
    mbedtls_sha256_init(&ctx2);
    mbedtls_sha256_clone(&ctx2, &ctx1);
    // Update ctx1/ctx2
    mbedtls_sha256_update(&ctx1, test_buf1, len2);
    mbedtls_sha256_update(&ctx2, test_buf1, len2);
    // Finish ctx1/ctx2
    mbedtls_sha256_finish(&ctx1, shasum1);
    mbedtls_sha256_finish(&ctx2, shasum2);
    // Free ctx1/ctx2
...
void test_sha256_perf(int is224)
{
    ...
    t2.start();
    mbedtls_sha256_starts(&ctx2, is224);
    i = MAXNUM_LOOP;
    while (i --) {
        mbedtls_sha256_update(&ctx2, test_buf2, sizeof (test_buf2));
    }
    mbedtls_sha256_finish(&ctx2, shasum2);
    t2.stop();
...
void test_sha512_nodata(void)
{
    ...
    mbedtls_sha512_context ctx1, ctx2;
    
    mbedtls_sha512_init(&ctx1);
    mbedtls_sha512_init(&ctx2);
    
    mbedtls_sha512_starts(&ctx1, 0);
    mbedtls_sha512_finish(&ctx1, shasum1);
    mbedtls_sha512_starts(&ctx2, 0);
    mbedtls_sha512_finish(&ctx2, shasum2);
...
void test_sha512_random_updates(void)
{
    ...
    mbedtls_sha512_starts(&ctx2, 0);
    for (i = 0; i < sizeof (update_sizes) / sizeof (update_sizes[0]); i ++) {
        mbedtls_sha512_update(&ctx2, test_buf1, update_sizes[i]);
    }
    mbedtls_sha512_finish(&ctx2, shasum2);
...
void test_sha512_clone(uint32_t len1, uint32_t len2)
{
    ...
    // Clone ctx2
    mbedtls_sha512_init(&ctx2);
    mbedtls_sha512_clone(&ctx2, &ctx1);
    // Update ctx1/ctx2
    mbedtls_sha512_update(&ctx1, test_buf1, len2);
    mbedtls_sha512_update(&ctx2, test_buf1, len2);
    // Finish ctx1/ctx2
    mbedtls_sha512_finish(&ctx1, shasum1);
    mbedtls_sha512_finish(&ctx2, shasum2);
    // Free ctx1/ctx2
...
void test_sha512_perf(int is384)
{
    ...
    t2.start();
    mbedtls_sha512_starts(&ctx2, is384);
    i = MAXNUM_LOOP;
    while (i --) {
        mbedtls_sha512_update(&ctx2, test_buf2, sizeof (test_buf2));
    }
    mbedtls_sha512_finish(&ctx2, shasum2);
    t2.stop();
